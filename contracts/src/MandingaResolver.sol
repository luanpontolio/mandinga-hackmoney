...
/**
 * @notice Mandinga Offchain ENS Resolver.
 ...
 */
contract MandingaResolver is ERC165, Manageable, IExtendedResolver {
        ...
        returns (bytes memory)
    {
        ...
        require(
            ...
            "MandingaResolver::resolveWithProof: invalid signature"
        );
        return result;
    }
